...
<div class="jarves-frame">
    <div class="jarves-main-menu-left">
        ...
        <div class="jarves-main-menu jarves-scrolling">
            ...
            <div *ngFor="#category of jarvesSession.getMenus()|mapToIterable; trackBy:fullPath" class="jarves-mainMenu-cat"
                 [class.jarves-mainMenu-cat-hidden]="menuHidden[category.fullPath]">
                <h2 (click)="menuHidden[category.fullPath] = !!!menuHidden[category.fullPath]">
                    {{category.label}}
                    <span class="jarves-mainMenu-cat-toggle icon-arrow-down-3" title="Hide"></span>
                </h2>
                <a *ngFor="#link of category.items; trackBy:fullPath" class="jarves-mainMenu-link"
