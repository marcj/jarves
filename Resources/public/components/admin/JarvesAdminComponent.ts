...
<jarves-interface *ngIf="jarvesSession.isInterfaceVisible()"></jarves-interface>
<jarves-backend-logs [errors]="backendLogger.errors"></jarves-backend-logs>
`
})
export default class JarvesAdminComponent {
    ...
    logout() {
        ...
        this.jarvesSession.setSession(null);
    }
    ...
    openEntryPoint(entryPoint, options, inline, dependWindowId) {
        entryPoint = window['angular'].isObject(entryPoint) ? entryPoint : this.getJarves().getEntryPoint(entryPoint);
